...
function tambah($data){
	...
	$query = "INSERT INTO berkala VALUES ('','$nama','$tmt','$naik','$message')";
...
function hapus($id){
	global $conn;
	mysqli_query($conn, "DELETE FROM berkala WHERE id = $id");
