...
$jumlahData = count(query("SELECT * FROM kepangkatan"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;
// $file = query("SELECT * FROM filem ORDER BY id DESC");
$file = query("SELECT * FROM kepangkatan ORDER BY id DESC LIMIT $awalData, $jumlahDataPerhalaman");
// tombol cari di klik
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="">Kepangkatan</a>
					</li>
					<li class="nav-item">
