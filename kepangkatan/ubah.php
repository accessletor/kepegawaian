...
$id = $_GET["id"];
// query data
$file = query("SELECT * FROM kepangkatan WHERE id = $id")[0];
...
<head>
  ...
  <title>Ubah Data Kepangkatan</title>
...
<body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      <label for="angkat" class="form-label">Naik</label>
      <input type="date" class="form-control" id="angkat" name="naik" value="<?= $file['naik']; ?>">
    </div>
    <div class="mb-3">
