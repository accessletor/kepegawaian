...
function tambah($data){
	...
	$query = "INSERT INTO kepangkatan VALUES ('','$nama','$tmt','$naik','$message')";
...
function hapus($id){
	global $conn;
	mysqli_query($conn, "DELETE FROM kepangkatan WHERE id = $id");
